...
**Duração sugerida:** 2 a 4 aulas (100 a 200 min)
...
Você foi contratado(a) como **desenvolvedor(a) web júnior** para auditar o site (pasta `site-com-erros/`), identificar os problemas e entregar uma versão corrigida e melhorada, mantendo o conteúdo e a identidade visual básica, mas resolvendo:
...
- Arquivos fornecidos: `site-com-erros/index.html` e `site-com-erros/style.css`.
